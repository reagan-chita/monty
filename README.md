...
```
$ git clone https://github.com/reagan-chita/monty.git
```
...
* **add**
  ...
  * The result is stored in the second element from the top and the top element is poppe* **sub**
s the top element of the stack/queue from the second element from the top.
